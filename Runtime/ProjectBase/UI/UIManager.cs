...
namespace Momos.Core.UI
{
    ...
    public class UIManager : BaseManager<UIManager>
    {
        ...
        public UIManager()
        {
            ...
            {
                obj = ResMgr.GetInstance().LoadInstance<GameObject>("UI/Canvas");
            ...
            if (obj == null)
                obj = ResMgr.GetInstance().LoadInstance<GameObject>("UI/EventSystem");
            GameObject.DontDestroyOnLoad(obj);
        }
        ...
        public void ShowPanel<T>(string panelName, E_UI_Layer layer = E_UI_Layer.Mid, UnityAction<T> callBack = null) where T : BasePanel
        {
            ...
            ResMgr.GetInstance().LoadInstanceAsync<GameObject>("UI/" + panelName, (obj) =>
            {
                //把他作为 Canvas的子对象
                //并且 要设置它的相对位置
                //找到父对象 你到底显示在哪一层
